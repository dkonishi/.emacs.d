...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (json-mode flycheck-joker lsp-mode cquery company-anaconda flycheck-clojure spaceline intero haskell-mode restclient vue-mode markdown-mode doom-themes))))
(custom-set-faces
